"""
Django settings for mcstat_47289 project.
...
ROOT_URLCONF = 'mcstat_47289.urls'
...
WSGI_APPLICATION = 'mcstat_47289.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mcstat_47289 API",
    "DESCRIPTION": "API documentation for mcstat_47289 App",
    "VERSION": "v1",
}
